...
#
#   1. Crie a pasta E:\POP+SUI 63 no seu computador (se ainda não existir).
#   2. Dentro dela, crie uma subpasta chamada "data".
#   3. Coloque estes 4 arquivos dentro de E:\POP+SUI 63\data\ (nomes EXATOS,
#      sem alterar nada, eles vieram junto com este script):
#        - GSE208261_raw_counts.tsv
#        - GSE208261_sample_metadata.csv
#        - Wei2020_TableS2_mRNA.xls
#        - kegg_pathway_names.csv
#   4. Abra o RStudio, abra este arquivo (.R), e rode do início ao fim
#      (Ctrl+Alt+R roda o script inteiro, ou clique em "Source").
#   5. Na PRIMEIRA vez que rodar, a Parte 0 vai instalar os pacotes que
#      faltarem no seu computador - isso pode demorar 5-15 minutos e só
#      acontece uma vez. Da segunda vez em diante já roda direto.
#   6. Resultados vão aparecer em E:\POP+SUI 63\results\ e as figuras em
...
## =============================================================================
# setwd() diz ao R "a partir de agora, quando eu disser 'data/algumacoisa',
# procure dentro desta pasta". Ajuste o caminho abaixo SE a sua pasta não for
# exatamente esta.
setwd("E:/POP+SUI 63")
...
arquivos_necessarios <- c(
  "data/GSE208261_raw_counts.tsv",
  "data/GSE208261_sample_metadata.csv",
  "data/Wei2020_TableS2_mRNA.xls",
  "data/kegg_pathway_names.csv"
)
...
if (length(faltando) > 0) {
  stop(
    ...
    "Solução: copie esse(s) arquivo(s) para dentro de ", file.path(getwd(), "data"), "\n",
    "com exatamente esse nome, e rode o script de novo.\n"
  )
}
cat("=== Os 4 arquivos de dados foram encontrados na pasta 'data'. Prosseguindo. ===\n\n")
